export const t = {
   ...
   ar: {
      ...
      hero: {
         since: "منذ 1994",
         title: "الزهرى للجلاتين الصناعى",
         subtitle: "جيلاتين عالي الجودة للاستخدامات الغذائية والدوائية والصناعية",
         cta: "استعرض المنتجات",
      },
      about: {
         label: "من نحن",
         title: "عقود من الخبرة في إنتاج الجيلاتين",
         body: "نحن من الشركات الرائدة في تصنيع الجيلاتين الصناعي، ملتزمون بتقديم منتجات عالية النقاء تلبي المعايير الدولية. يضمن مصنعنا المتطور الدقة في كل مرحلة من مراحل الإنتاج.",
         getIt: "أحصل عليه الأن"
      },
      products: {
         label: "منتجاتنا",
         title: "حلول الجيلاتين لكل الصناعات",
         items: [
         { id: "prod-1", name: "جيلاتين غذائي", desc: "يُستخدم في صناعة الحلويات ومنتجات الألبان واللحوم." },
         { id: "prod-2", name: "جيلاتين دوائي", desc: "كبسولات صلبة وناعمة وأغلفة الأقراص." },
         { id: "prod-3", name: "جيلاتين صناعي", desc: "المواد اللاصقة والتصوير الفوتوغرافي والتطبيقات التقنية." },
         { id: "prod-4", name: "ببتيدات الكولاجين", desc: "جيلاتين متحلل للتغذية ومستحضرات التجميل." },
         ],
      },
      certificate: {
         label: "الاعتمادات",
         title: "الشهادات والمعايير الدولية",
         certificates: [
            {
               id: "CERT-1",
               name: "ISO 9001",
               desc: "نطبق أفضل الممارسات العالمية لضمان جودة المنتجات واستقرار العمليات التشغيلية.",
               type: "نظام إدارة الجودة"
            },
            {
               id: "CERT-2",
               name: "ISO 14001",
               desc: "نلتزم بإدارة بيئية مسؤولة وتقليل الأثر البيئي لعمليات الإنتاج.",
               type: "الإدارة البيئية"
            },
            {
               id: "CERT-3",
